...
global tplus, infoLenth, speed, reHandShake, communicationLog, communicationCount
...
def main():
    fileNum = 1
    if os.path.isfile(communicationLog):
        with codecs.open(communicationLog, 'r', 'utf-8') as f:  # 打开文件
    ...
    with open(communicationLog, 'at') as f:
        print('\n*********************************\n\tcommunication start\n*********************************\n', file=f)
    t = 0
